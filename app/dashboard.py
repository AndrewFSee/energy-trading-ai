...
# Title & KPI Row
# â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
st.title("âš¡ Energy Quant Dashboard â€” Natural Gas")
st.markdown(
    "Storage valuation Â· Spark spreads Â· Portfolio VaR Â· LLM research synthesis"
)
...
with tab_price:
    ...
    with st.expander("ðŸ“Š Technical Indicators (last 5 days)"):
        try:
    ...
    # Return distribution
    with st.expander("ðŸ“‰ Return Distribution"):
        fig_hist = go.Figure()
...
with tab_storage:
    ...
    if sv is None:
        ...
        st.subheader(f"Storage Valuation â€” {asset.name}")
        st.caption(
        ...
        with st.expander("ðŸ“‹ Optimal Monthly Schedule"):
            sched = intr.schedule
...
with tab_spark:
    ...
    if ss is None:
        ...
        with st.expander("ðŸ­ Profitability by Plant Type"):
        ...
        with st.expander("ðŸ”— Spark Spread Correlation Matrix"):
            ss_df = pd.DataFrame(
...
with tab_var:
    ...
    if var_data is None:
        ...
        # Confidence ladder
        with st.expander("ðŸ“ VaR Confidence Ladder"):
            st.dataframe(
        ...
        # Stress testing
        st.markdown("---")
        st.markdown("#### ðŸŒªï¸ Energy Stress Scenarios")
        ...
        # VaR Backtest
        with st.expander("ðŸ“Š VaR Model Backtesting (Kupiec Test)"):
            for label, bt in var_data["backtest"].items():
                status = "âœ… Accepted" if bt["model_accepted"] else "âŒ Rejected"
                st.markdown(f"**{label} VaR Backtest** â€” {status}")
...
# â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
# TAB 5 â€” AI Morning Note
# â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
with tab_note:
    st.subheader("ðŸ§  AI-Generated Energy Market Morning Note")
    st.caption(
    ...
    if st.button("ðŸ”„ Generate New Morning Note (calls OpenAI)", key="gen_note"):
